					...
					<div className="exceptional-plant-varieties">
						<div className="text">
							...
							<p>
								...
								purification, thrive in low light, or are safe for your pets.
								Our mission is to help you transform your space with plants that
								bring life, style, and serenity, all while matching your
								lifestyle. 🌿
							</p>
						</div>
						<img
